...
const StickyHeadTable = (props) => {
  ...
  useEffect(()=>{
    ...
    axios
    .post(
      `${process.env.REACT_APP_API_URL}/attendancemanage/ot_authorization_list `,Data,
                  ...
                  return (
                    <TableRow hover role="checkbox" tabIndex={-1} key={idx}>
                      ...
                      <TableCell key="Options">
                        <span>
                           <Checkbox onClick={()=>selectHandler(row)} checked={row.authorized} disabled={row.authorized}/>
                        </span>
                      </TableCell>
                    </TableRow>
                  );
